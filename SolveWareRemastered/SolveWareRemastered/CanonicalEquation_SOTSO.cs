...
{
    public partial class CanonicalEquation_SOTSO : Form
    {
        public CanonicalEquation_SOTSO()
        {
            InitializeComponent();
            FileReading();
            CustomApp();
        ...
        double Tick = 1;
        int MaxTrack = 100;
        double A, B, C, F = 0, G = 0, H = 0, P = 0, Q = 0, R = 0, D;
        ...
        private void FileReading()
        {
            ...
            try
            {
                StreamReader file = new StreamReader("CanonicalEquation_SOTSO.txt");
                line = file.ReadLine();
                while (line != null)
                {
                    if (operation == 0)
        ...
        private void ClosingForm_Click(object sender, EventArgs e)
        {
            try
            {
                StreamWriter file = new StreamWriter("CanonicalEquation_SOTSO.txt");
